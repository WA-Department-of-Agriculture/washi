...
![](man/figures/README-install-fonts.png){fig-alt="Windows folder containing Lato and Poppins .ttf font files selected and a dropdown shows 'Install' highlighted."}
