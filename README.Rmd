...
Load the {extrafont} package in each session with `library(extrafont)`. If you have any issues, please see the [{extrafont} documentation](https://github.com/wch/extrafont) for detailed requirements and instructions.
