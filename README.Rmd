...
**Package documentation: <https://wa-department-of-agriculture.github.io/washi/>.**
...
This function will open a window with the font files for you to install, and provides instructions for installation. Alternatively, you can download and install the font families directly from Google:
...
Once they are installed, you will need to register them for use in R with:
